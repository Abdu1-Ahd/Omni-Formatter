//! Ruby / PHP / Perl / Lua — rubocop / php-cs-fixer / stylua Language Module
//!
...
#[cfg_attr(feature = "standalone", wasm_bindgen)]
pub fn language_id() -> String { "ruby".to_string() }

#[cfg_attr(feature = "standalone", wasm_bindgen)]
pub fn aliases() -> Vec<JsValue> {
    vec![
        JsValue::from_str("php"),
        JsValue::from_str("perl"),
        JsValue::from_str("lua"),
        JsValue::from_str(".rb"),
        JsValue::from_str(".php"),
        JsValue::from_str(".pl"),
        JsValue::from_str(".pm"),
